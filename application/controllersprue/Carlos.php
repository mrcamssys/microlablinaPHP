           ...
           $polos=Raices::calculaRaices($this->textbox2tf->arpolos());
            ...
            if(count($this->textbox2tf->arceros())>1)
            {
              ...
              $this->texto['raices'][0] = "<br>Ceros del sistema   ".stringlatex::ImpRoos($ceros)."   <br>";
                ...
                $this->texto['raices'][0] =  "sistema tiene ".count($polos). " ceros en el infinito";
...
//diagrama de bode
            $bode=Bode::plotBode($this->textbox2tf->arceros(),$this->textbox2tf->arpolos());
        	$this->texto['bode']=$bode;
        	$face=Bode::plotFase($this->textbox2tf->arceros(),$this->textbox2tf->arpolos());
        	$this->texto['fase']=$face;
        	//echo $bode;
//fin diagrama de bode
