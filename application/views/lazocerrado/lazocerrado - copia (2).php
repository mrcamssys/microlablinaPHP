    ...
    <div class="container">
      ...
      <div class="col-lg-3 mb-4">
        ...
        <div class="col-lg-9 mb-4">
          ...
          <p>Un sistema del lazo cerrado con realimentación negativa, permite mediante otro sistema llamado controlador, hacer que una planta funcione de una manera específica, la realimentación permite comparar, la salida que produce G(s) y H(S) con un a entrada, a esta comparación se le llama error, y permite a G(s) tomar acciones que permitan minimizar el error.</p>
          ...
          Ejemplo de lazo abuerto de dos sistemas en cascada: 
          <center>
          <img src="<?php echo base_url();?>images/cabecera1/explicar/lazoopen.png" class="img-fluid" alt="Responsive image">
          </center>

          A continuación: seleccione <b>Información</b> para saber algo más sobre sistemas u <b>Operar lazo cerrado</b>, para hacer cálculos de un sistema con realimentación negativa estos conectados en cascada.
