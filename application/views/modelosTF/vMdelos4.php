...
<div class="card text-center">
  <div class="card-header">
    Criterios de estabilidad de Ruth
  </div>
  <div class="card-body">
    <h5 class="card-title">Ojo tener en cuenta:</h5>
    <p class="card-text">Los cambios de signo en la primera columna indican que el sistema no es estable</p>
 ...
 <!--<div id="ruth" class="tab-pane fade">-->
  <?=$datos?>
 <!--</div>-->
