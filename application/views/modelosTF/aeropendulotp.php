      ...
      <div class="col-lg-9 mb-4">
        ...
        <div class="collapse" id="collapseExample">
          <div class="card card-body">
           <ul>
<li>\(L\)  longitud de la vara \([m]\)</li>
<li>\(M_g\) Peso del motor \([K_g]\)</li>
<li>\(K\) coeficiente de empuje </li>
<li>\(C\) Coeficiente de Fricción</li>
<li>\(T\) Fuerza de la hélice</li>
<li>\(\mu\) Energía Requerida</li>
          </ul>
          </div>
        </div>
        ...
        <?php if($this->input->post("enviado")==1){?>
          ...
          <form action="<?php echo base_url();?>TranferFuncion/calcular" method="post" name="transfer" id="transfer" target="_parent" novalidate>
            <input type="hidden" name="ceros" id="ceros" value="<?= $arpen_num;?>" >
            <input type="hidden" name="polos" id="polos" value="<?= $arpen_den;?>" >
        ...
        <h4>Ingrese los parametros del sistema</h4>
            <form action="<?php echo base_url();?>tfaeropendulo/pidaeropendulo" method="post" name="transfer" id="transfer" target="_parent" novalidate>
            

            <div class="control-group form-group">
              <div class="controls">
                <label>\(L\)  longitud de la vara \([m]\)</label>
                <input type="tel" class="form-control" name="arpen_l" id="arpen_l" value="<?= $arpen_l;?>"  required data-validation-required-message=" ">
            ...
            <div class="control-group form-group">
              <div class="controls">
                <label>\(M_g\) Peso del motor \([K_g]\)</label>
                <input type="tel" class="form-control" name="arpen_mg" id="arpen_mg" value="<?= $arpen_mg;?>"  required data-validation-required-message=" ">
                <p class="help-block"></p>
              </div>
            </div>
            ...
            <div class="control-group form-group">
              <div class="controls">
                <label>\(K\) coeficiente de empuje</label>
                <input type="tel" class="form-control" name="arpen_k" id="arpen_k" value="<?= $arpen_k;?>"  required data-validation-required-message=" ">
                <p class="help-block"></p>
              </div>
            </div>
            ...
            <div class="control-group form-group">
              <div class="controls">
                <label>\(C\) Coeficiente de Fricción</label>
                <input type="tel" class="form-control" name="arpen_c" id="arpen_c" value="<?= $arpen_c;?>"  required data-validation-required-message=" ">
                <p class="help-block"></p>
              </div>
            </div>
            ...
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="tel" class="form-control" name="kd" id="kd" value="<?= $kd;?>"  required data-validation-required-message=" ">
                <p class="help-block"></p>
              </div>
            </div>
