...
<script type="text/javascript">
  function barra(data){
    ...
    <div class="container-fluid">
      ...
      <!-- Etapa de programación de vistas -->
...
<form  method="post" name="transfer" id="transfer" target="_parent" novalidate>          
          <!-- Comienzo del acordeón -->
          <div class="accordion1">
            <div class="card">
              <div class="card-header" id="headingOne">
                <h5 class="mb-0">
                  <a class="btn btn-link  btn-sm" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Estableciendo requisitos del sistema</a>
                </h5>
              </div>
...
<div class="row">
  <div class="col-xs-6 col-md-6"><!--Columna primaria-->
...
<div class="alert alert-dark" role="alert">
 Esto establece una tabla de relación entre el \([\tau]\) y el polo, dando como resultado los posibles puntos donde se puede estabilizar graficándo la respuesta del del sistema.
</div>
</div>
