 ...
 <!-- Page Content -->
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Funcion de Transferencia
        <small>Sistemas Dinamicos (Laplace)</small>
      </h1>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">usted podrá realizar operaciones con funciones de trasferencia cerrando el lazo abierto, aquí se pueden operar sistemas en cascada,.<br> <b><i>Nota:</i></b> la realimentación del lazo en negativa.</p>
            </div>
            <div class="card-footer">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">
            ...
            <div class="card-body">
              ...
              <b><i>Nota: </i></b> Este módulo se encuentra con las operaciones básicas basadas en los libros de control de  dorf y ogata , el grafico de LGR aún se encuentra sujeto a cambios.
            </div>
            <div class="card-footer">
