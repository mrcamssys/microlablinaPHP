...
<meta name="apple-mobile-web-app-capable" content="yes">
    ...
    <!-- librerias para presentaciones-->
    <link rel="stylesheet" href="<?php echo base_url();?>stilos/presentacion/css/reset.css">
    <link rel="stylesheet" href="<?php echo base_url();?>stilos/presentacion/css/reveal.css">
    <link rel="stylesheet" href="<?php echo base_url();?>stilos/presentacion/css/theme/League.css" id="theme">
    <!-- Theme used for syntax highlighting of code -->
    <link rel="stylesheet" href="<?php echo base_url();?>stilos/presentacion/lib/css/monokai.css">
...
<script id="MathJax-script" async src="https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-mml-chtml.js"></script>
    ...
    <script>
      ...
      link.rel = 'stylesheet';
      link.type = 'text/css';
      link.href = window.location.search.match( /print-pdf/gi ) ? '<?php echo base_url();?>stilos/presentacion/css/print/pdf.css' : '<?php echo base_url();?>stilos/presentacion/css/print/paper.css';
...
-->
            ...
            <li class="nav-item dropdown">
              ...
              <div style="background-color: #f4f4f4;">  
                ...
                <a class="dropdown-item" href="<?php echo base_url();?>/ULogin">Eres Nuevo? Registrarte Aquí</a>
