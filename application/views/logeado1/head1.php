     ...
     <div class="otros d_none d-lg-none collapse" id="navbarResponsivem">
      <div class="menu_icons_nver">
        ...
        <ul>
          ...
          <li>
            <a href="<?= base_url()?>tfaeropendulo"><span class="mlicon-arpendulo"></span><p>Aeropéndulo</p></a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url();?>gestor/"><span class="icon-contacto"></span>&nbsp Preguntas</a>
            </li>       
<!--
            <li class="nav-item">
...
-->
            ...
            <li class="nav-item d-none d-sm-block">
              <a class="nav-link" href="<?php echo base_url();?>Mdelsystf/"><span class="icon-sigma"></span>&nbsp Modelos de Sistemas</a>
            </li>
            ...
            <!--<li class="nav-item dropdown">-->
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownPortfolio" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><span class="icon-user-check"></span>&nbsp Mi Cuenta 
              </a>
              <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg" aria-labelledby="navbarDropdownPortfolio">
                <a class="dropdown-item" href="<?php echo base_url();?>/user">Configuración de cuenta</a>
                <a class="dropdown-item" href="<?php echo base_url();?>?logout=ok">Cerrar Cuenta</a>
              </div>
            </li>
