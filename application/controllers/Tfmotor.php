    ...
    public function __construct(){
         ...
         parent::__construct();
           $this->menu=[
            ...
            base_url()."tfmotor/teoria"=>"Teoría del Sistema",
            ]; 
    }

 public function index(){
    $this->load->library('Menu1');
 	  $this->texto['menux']=new Menu1($this->menu,"Teoría del Sistema");
...
public function tfmotorVE(){
    $this->librerias();
    $this->texto['menux']=new Menu1($this->menu,"Representación en Variables Estado");
    if(isset($this->session->email)){       
        $this->load->view('logeado/head1');  
        $this->load->view('logeado/cabecera1');
       $this->load->view('modelosTF/tf_motordc',$this->texto);
