...
class Tf{
        ...
        public function getfracpar(){
          ...
          $texto['inversaplace']="";
            ...
            {
                $texto['Fparciales'] = $texto['Fparciales']. "   Fraccion parcial A".$p."<br><div class=\"table-responsive\"> ".stringlatex::latexPrintTF($pruebafracpar->OutFracPar()[$p][0],$pruebafracpar->OutFracPar()[$p][1],1)."</div>";
