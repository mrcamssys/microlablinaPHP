...
public static function latexpoli($polinomio){
    ...
    public static function latexmultipol($polinomios){
      ...
      public function imprimir(){
        ...
        return "<h5>Transformacion Bilineal</h5>Esta funcion se usa, para trabajar con la funcion de transferencia  usando otras señales esta varia segun el periodo de muestreo.<br>
